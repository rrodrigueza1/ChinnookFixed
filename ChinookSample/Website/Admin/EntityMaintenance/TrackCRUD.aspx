<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TrackCRUD.aspx.cs" Inherits="Admin_EntityMaintenance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="jumbotron">
        <h3> Wired ListView CRUD</h3>
    </div>
    <asp:ListView ID="TrackLists" runat="server" DataSourceID="TrackListODS" InsertItemPosition="LastItem" DataKeyNames="TrackId">
        <AlternatingItemTemplate>
            <tr style="background-color: #FFF8DC;">
                ...
                <td>
                    <asp:DropDownList ID="AlbumList" SelectedValue='<%#Eval("AlbumId") %>' runat="server" DataSourceID="AlbumListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="MediaTypeLists" SelectedValue='<%#Eval("MediaTypeId") %>' runat="server" DataSourceID="MediaTypeListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>

                </td>
                <td>
                    <asp:DropDownList ID="GenreLists" SelectedValue='<%#Eval("GenreId") %>' runat="server" DataSourceID="GenreListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>
        ...
        <EditItemTemplate>
            <tr style="background-color: #008A8C; color: #FFFFFF;">
                ...
                <td>
                    <asp:DropDownList ID="AlbumList" SelectedValue='<%#Bind("AlbumId") %>' runat="server" DataSourceID="AlbumListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="MediaTypeLists" SelectedValue='<%#Bind("MediaTypeId") %>' runat="server" DataSourceID="MediaTypeListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>

                </td>
                <td>
                    <asp:DropDownList ID="GenreLists" SelectedValue='<%#Bind("GenreId") %>' runat="server" DataSourceID="GenreListODS" DataTextField="DisplayText" DataValueField="PFKeyIdentifier">
                        <asp:ListItem Value="0" Text="Select Drop Down Lists"></asp:ListItem>
                    </asp:DropDownList>
    ...
    <asp:ObjectDataSource ID="TrackListODS" runat="server" DataObjectTypeName="ChinookSystem.Data.Entities.Track" DeleteMethod="DeleteTrack" InsertMethod="Add_Track" OldValuesParameterFormatString="original_{0}" SelectMethod="ListTracks" TypeName="ChinookSystem.BLL.TrackController" UpdateMethod="Update_Track"></asp:ObjectDataSource>
